...
| Evaluation (Python packages) | **Alliance Cloud VM** on Arbutus (`<vm-instance>`, 8 vCPU / 12 GB) running `socbench-worker.service` with the Docker sandbox — see `docs/drac-migration.md` → *Runbook* | free (Alliance allocation) |
