...
const SECTIONS: { title: string; items: { q: string; a: React.ReactNode }[] }[] = [
  {
    ...
    items: [
      ...
      { q: "Which files are valid?", a: <>Only a .zip containing <code>Model.m</code> or <code>Model.p</code> and <code>Settings.xlsx</code> at the top level, plus any supporting files. Sub-folders, renamed files, or missing Settings fields are rejected before upload completes. The default size limit is 50 MB.</> },
