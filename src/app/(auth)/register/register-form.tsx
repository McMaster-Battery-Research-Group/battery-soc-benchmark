...
export function RegisterForm() {
  ...
  return (
    <form action={action} className="mt-6 space-y-4" noValidate>
      ...
      <Field label="Affiliation" name="affiliation" autoComplete="organization" required placeholder="e.g. McMaster University" defaultValue={state.values?.affiliation} error={state.errors?.affiliation} />
      <Field label="Password" name="password" type="password" autoComplete="new-password" required error={state.errors?.password} hint="At least 8 characters with upper- and lowercase letters and a number." />
