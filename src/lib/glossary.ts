...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  { key: "bms", term: "Battery management system (BMS)", group: "Basics", short: "The on-board electronics that monitor a battery and run the SOC estimator in a real vehicle." },
  ...
  { key: "ocv", term: "Open-circuit voltage (OCV)", group: "Tests & data", short: "The cell voltage after resting with no current; it maps almost one-to-one to SOC, which many estimators exploit." },
  ...
  { key: "payload", term: "Payload / HVAC cases", group: "Tests & data", short: "Each cell was cycled with a different vehicle load: 80, 448 or 1000 kg of payload, with cabin heating/cooling on or off, so the data spans light to heavy use." },
  ...
  { key: "maxe", term: "Max error (MAXE)", group: "Metrics", short: "The single worst instantaneous SOC error in a cycle. Shows how badly a model can be wrong even if it is usually accurate." },
  ...
  { key: "ekf", term: "Kalman filter (EKF/UKF)", group: "Methods", short: "A model-based estimator that blends a battery model's prediction with voltage measurements, correcting drift. EKF and UKF handle the non-linear voltage–SOC relationship in different ways." },
  { key: "ecm", term: "Equivalent-circuit model (ECM)", group: "Methods", short: "A battery represented as a voltage source plus resistors and capacitors; its parameters come from HPPC data and feed Kalman-filter estimators." },
  { key: "nn", term: "Neural-network estimators (FNN, LSTM, GRU, Transformer)", group: "Methods", short: "Data-driven models trained on the open data to map measurements to SOC. Recurrent types (LSTM, GRU) keep memory of past samples; FNNs use averaged inputs instead." },
