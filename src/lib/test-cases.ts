...
export const TEST_CASES: TestCaseDef[] = [
  ...
  { key: "massM80", test: 5, label: "80 kg payload", short: "80 kg", group: "conditions", description: "Range of loads — single-passenger vehicle model (m80 cell, HVAC on).", weight: 0.033, defaultVisible: false },
  { key: "massM448", test: 5, label: "448 kg payload, HVAC on", short: "448 kg · HVAC on", group: "conditions", description: "Range of loads — maximum rated payload with cabin HVAC (m448 cell).", weight: 0.067, defaultVisible: false },
  { key: "massM448N", test: 6, label: "448 kg payload, HVAC off", short: "448 kg · HVAC off", group: "conditions", description: "Range of loads — maximum rated payload without cabin HVAC (m448-N cell).", weight: 0.067, defaultVisible: false },
  { key: "massM1000", test: 5, label: "1000 kg payload", short: "1000 kg", group: "conditions", description: "Range of loads — towing a small trailer (m1000 cell). Highest current demand.", weight: 0.033, defaultVisible: false },
  ...
  { key: "tempM20", test: 9, label: "−20 °C", short: "−20 °C", group: "temperature", description: "m80 cell at −20 °C ambient. Resistance is ~10× higher than at 40 °C.", weight: 0.017, defaultVisible: true },
  { key: "tempM10", test: 9, label: "−10 °C", short: "−10 °C", group: "temperature", description: "m80 cell at −10 °C ambient.", weight: 0.017, defaultVisible: false },
  { key: "temp0", test: 9, label: "0 °C", short: "0 °C", group: "temperature", description: "m80 cell at 0 °C ambient.", weight: 0.017, defaultVisible: false },
  { key: "temp10", test: 9, label: "10 °C", short: "10 °C", group: "temperature", description: "m80 cell at 10 °C ambient.", weight: 0.017, defaultVisible: false },
  { key: "temp25", test: 9, label: "25 °C", short: "25 °C", group: "temperature", description: "m80 cell at 25 °C ambient.", weight: 0.017, defaultVisible: false },
  { key: "temp40", test: 9, label: "40 °C", short: "40 °C", group: "temperature", description: "m80 cell at 40 °C ambient.", weight: 0.017, defaultVisible: false },
