...
export const EXAMPLES: ExampleModel[] = [
  {
    ...
    files: [{ name: "Model.m", note: "the estimator" }, { name: "Settings.xlsx", note: "author, affiliation, email, model name" }],
...
function [Y_est, z] = Model(X, z)
  ...
  },
  {
    ...
    files: [
      ...
      { name: "Settings.xlsx", note: "author, affiliation, email, model name" },
    ],
...
if abs(SOC_Pred - z.Param.SOC_now) > 0.02
  ...
  },
  {
    ...
    files: [{ name: "Model.m", note: "estimator with embedded weights (IW1_1, LW2_1, LW3_2, biases)" }, { name: "Settings.xlsx", note: "author, affiliation, email, model name" }],
...
function x = mapminmax_reverse(y, s)
  ...
  },
  {
    ...
    files: [{ name: "Model.m", note: "estimator with embedded lstmWeights, lstmRecurrentWeights, lstmBias, fcWeights" }, { name: "Settings.xlsx", note: "author, affiliation, email, model name" }],
